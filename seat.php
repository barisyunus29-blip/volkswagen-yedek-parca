...
$seatModeller = ["Leon","Ibiza","Altea","Cordoba","Toledo"];
...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    $query = "SELECT * FROM `stok` WHERE `Marka` = 'Seat'";
    $params = [];
...
<head>
<meta charset="UTF-8">
<title>Seat Yedek Parça | Volkswagen Group Parça Dünyası</title>
<style>
...
<body>
<header>
    <h1>Seat Yedek Parça</h1>
    <p>Seat aracınız için orijinal, kaliteli ve uygun fiyatlı yedek parçalar burada!</p>
</header>
<nav>
<ul>
...
<div class="container">
    <div class="panel">
        ...
        <form method="post">
            ...
            <input type="text" name="stok_kod" id="stok_kod" placeholder="Örn: SEAT1234">
    ...
    <div class="content">
        <h2>Orijinal Seat Yedek Parçalar</h2>
        <p>Seat araçları için en kaliteli orijinal yedek parçaları stoklarımızda bulabilirsiniz.</p>
